    ...
    <div id="balance-container" className="flex flex-col justify-evenly ">
      <div id="balance-header-container" className="flex justify-between w-full h-fit  leading-snug p-2 relative bottom-6">
        <div id="header-left-container" className="flex w-[100%] flex-col items-start h-full mr-3">
          <div id="header-text" className="w-fit "><h2 className="text-[20px] font-[800] text-black dark:text-whiten">Receipts</h2></div>
          <div id="header-bottom-statement" className="w-full mt-1"><p className="text-[10px] font-[400] text-slate-600 dark:text-white">View all receipts for credit purchases associated with this account, across campaigns and advertisers.</p></div>
        </div>
      </div>
      ...
      <div id="body" className="w-full h-[90vh] flex flex-col justify-center items-center gap-1">
          ...
          <h1 className=" font-bold leading-snug dark:text-white text-black-2 ">No Receipts</h1>
          <p className="text-[12px] font-[500]">You don't have any receipts yet</p>
      </div>
    </div>
    </main>  
  );
